...
def build():
    ...
    db.session.add(m11)
    db.session.add(m21)
    mzjc1 = usridea(username='zjc',text='天行健，君子以自强不息！')
    mzjc2 = usridea(username='zjc', text='好好学习，天天向上！')
    mzjc3 = usridea(username='zjc', text='大道理都懂，小情绪难控')
    mzzc1 = usridea(username='zzc', text='心有所向，日复一日，必有精进')
    ...
    db.session.add(b)
    b = bookitem(name='如父如子', author='[日] 是枝裕和', publish='湖南文艺出版社', isbn='9787540484651', price='49.80', number=7, type='文学',intro='当意识到孩子也在注视着自己时，那一瞬间，便懂得了什么是如父如子。至今为止都过着一帆风顺的人生的野野宮良多，是大型建筑公司里的精英社员。他和妻子绿结婚多年，感情十分要好，两人共同养育着聪明乖巧的儿子庆多。本以为平静生活将一直持续的三人没有想到的是，一通来自庆多出生医院的 电话将这个小家庭卷到了风口浪尖。面对命中注定的血缘与日夜相伴的亲情，良多骄傲又脆弱的内心摇摆不定。两个家庭站在了人生的十字路口前。分分秒秒，经年累月积淀下来的父子亲情，早已超越了血缘的羁绊。', pubdate='2018-4')
    db.session.add(b)
